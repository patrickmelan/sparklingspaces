...
export default function About() {
  ...
  return (
    <div className='w-full mx-auto bg-slate-50 py-8'>
        <div className="flex items-center gap-4">
            <div className="flex-col justify-center w-3/5 py-4">
                <div className='text-center'>
                    <h1 className='text-black text-3xl'>Trust us to make your space <span style={{color: "#FACC15"}} className={dancing_script.className}>sparkle</span></h1>
                </div>
                <div className='flex justify-center w-full'>
                    <div className='flex flex-col justify-center space-y-4 w-5/6 py-4 pl-4'>
