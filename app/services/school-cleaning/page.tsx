...
function SchoolCleaning() {

  const obj = serviceList[4];
        ...
        <div className="flex-col h-[70svh]">
            ...
            <div className="flex w-full h-3/4 py-8 space-x-8 px-8 items-center">
                ...
                <div className="flex w-1/2 h-full items-center px-2">
                    <Image src={`/${obj.image}`} alt={`Image of ${obj.name}`} width={250} height={350} className="w-full h-1/2 rounded-md shadow-slate-400 shadow-md" />
                </div>
            </div>
        </div>
